...
#' Tree.crab <- PPtree_splitMOD("Type~.", data = crab[train,], PPmethod = "LDA", size.p =1)
#' Tree.crab
#' 
#'  Tree.result <- PPTreeclass(Type~.,data = crab[train,],"LDA")
#' Tree.result
#' 
#' PPclassify(Tree.result,crab[-train,-1],1,crab[-train,1])
