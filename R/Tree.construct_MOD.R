...
#' @param projbest.node something
#' @param splitCutoff.node something
#' @param PPmethod method for projection pursuit; "LDA", "PDA"
#' @param r r in Lr index
#' @param lambda weight flag in PDA index
#' @param TOL tolerance
#' @param maxiter something
#' @param q 1D proj
#' @param weight weight flag in LDA, PDA 
#' @param tol tolerance
#' @param strule select the stoping rule based, 1 = pure node, 2 = size of node, 3 = entropy
#' @param tot total observarions of the original class
